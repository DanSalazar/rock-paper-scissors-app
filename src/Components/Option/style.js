...
export const OptionBorder = styled.div`
  ...
  cursor: pointer;
  padding: 0.875em;
  background: ${props => props.gradient && `linear-gradient(to top, ${props.gradient})`};
  ...
  @keyframes winAnim {
    ...
    100% {
      box-shadow: 0px 0px 0px 2em rgb(204 204 204 / 10%), 
      0px 0px 0px 3em rgb(204 204 204 / 5%), 
      0px 0px 0px 4em rgb(204 204 204 / 2%);
      transform: scale(1.1);
    }
  }
